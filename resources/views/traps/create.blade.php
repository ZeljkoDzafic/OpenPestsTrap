    ...
    <div class="row">
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">Add trap</div>

                <div class="panel-body">
            {!! Form::open(['route' => 'traps.store' ,'class'=>'form-horizontal']) !!}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('pests_network_id', $networks,0, ['class' => "form-control"]) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input name="start_date" type="text" class="form-control"  value="{{ old('name', '') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input name="description" type="text" class="form-control"  value="{{ old('name', '') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="latitude" type="hidden" value="123" />
                        <input name="longitude" type="hidden" value="123123" />
                    </div>
                </div>
